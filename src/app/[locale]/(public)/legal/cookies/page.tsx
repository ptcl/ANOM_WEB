    ...
    return (
        <>
            <Container height='fit-title' textAlign='center'>
                ...
                <section className='flex flex-col justify-center items-center text-center w-full mb-8'>
                    <h1 className='leading-8 md:leading-25 gradient__vex font-semibold text-4xl md:text-7xl lg:text-9xl uppercase text-transparent z-10 mx-auto' data-text={t('legal.cards.cookies.title')}>
                        {t('legal.cards.cookies.title')}
                    </h1>
                    <p className='Grotesk text-[var(--light-dark-3)] text-sm md:text-lg max-w-xl z-10 mx-auto mb-8'>
                        {t('legal.cards.cookies.description')}
                    </p>
                </section>
            </Container>
